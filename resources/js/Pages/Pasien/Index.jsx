    ...
    <LabkesdaLayout>
        ...
        <div className="relative overflow-hidden bg-white shadow-md dark:bg-gray-800">
          <div className="flex flex-col space-y-3 px-4 py-3 lg:flex-row lg:items-center lg:justify-between lg:space-x-4 lg:space-y-0">
            <div className="flex flex-1 items-center space-x-4">
              <h5>
                <span className="text-gray-500">Jumlah Pencarian:</span>
                <span className="dark:text-white">146</span>
              </h5>
              <h5>
                <span className="text-gray-500">Total Pasien:</span>
            ...
            <table className="w-full text-left text-sm text-gray-500 dark:text-gray-400">
              ...
              <tbody>
                <tr className="border-b hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-700">
                  ...
                  <td className="px-4 py-2">Jakarta, 15/03/1985</td>
                  <td className="px-4 py-2">081234567890</td>
                  <td className="px-4 py-2">Kebayoran Baru</td>
                  <td className="px-4 py-2">Senayan</td>
                  <td className="px-4 py-2">Jl. Sudirman No. 123</td>
                  <td className="px-4 py-2">Karyawan Swasta</td>
                ...
                <tr className="border-b hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-700">
                  ...
                  <td className="px-4 py-2">Bandung, 22/07/1990</td>
                  <td className="px-4 py-2">082345678901</td>
                  <td className="px-4 py-2">Ciputat</td>
                  <td className="px-4 py-2">Ciputat Timur</td>
                  <td className="px-4 py-2">Jl. Raya Ciputat No. 45</td>
                  <td className="px-4 py-2">Ibu Rumah Tangga</td>
      ...
      >
        ...
        <ModalBody className="max-w-2xl">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="col-span-2 md:col-span-1">
              ...
              <TextInput type="text" id="nama" placeholder="Nama Pasien" />
            </div>
            <div className="col-span-2 md:col-span-1">
        ...
        <ModalFooter>
          ...
          <Button color="light" onClick={() => setOpenModalFilter(false)}>
            Batal
          </Button>
        </ModalFooter>
      </Modal>
