        ...
        return pemeriksaan.layanan_order.map((item) => {
            if (item.tipe === 'paket') {
                const paket = (paketLayanan || []).find(
                    (currentPaket) =>
                        currentPaket.id === item.paket_pemeriksaan_id,
                );
                ...
                const inferredQuantity =
                    hargaSatuan > 0 && Number(item.harga) > 0
                        ? Math.max(
                              1,
                              Math.round(Number(item.harga) / hargaSatuan),
                          )
                        : 1;
...
export default function PendaftaranLaboratorium({
    ...
    const filteredAvailableItems = useMemo(() => {
        ...
        return availableItems
            .filter(
                (item) =>
                    itemTypeFilter === 'all' || item.tipe === itemTypeFilter,
            )
            .filter((item) => {
        ...
        const fetchJenisLayanan = async () => {
            ...
            try {
                const response = await axios.get(
                    route('jenis-layanan.jenis-pasien'),
                    {
    ...
    const addSelectedItem = (nextItem) => {
        syncSelectedItems((prev) => {
            const exists = prev.some(
                (item) =>
                    item.tipe === nextItem.tipe && item.id === nextItem.id,
            );
    ...
    const handleSubmit = (e) => {
        ...
        if (pemeriksaan) {
            put(
                route('update-pendaftaran-laboratorium', [
                    pasien.id,
                    pemeriksaan.id,
                ]),
                {
                    ...
                    onError: () => {
                        alert(
                            'Terjadi kesalahan saat memperbarui pendaftaran.',
                        );
                    },
                },
            );
                                        ...
                                        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                            ...
                                            <div>
                                                ...
                                                <Select
                                                    ...
                                                    value={
                                                        data.hubungan_penanggung_jawab
                                                    }
                                                    onChange={(e) =>
                                                        setData(
                                            ...
                                            <div>
                                                ...
                                                <TextInput
                                                    ...
                                                    type="text"
                                                    value={
                                                        data.tempat_lahir_penanggung_jawab
                                                    }
                                                    onChange={(e) =>
                                                        setData(
                                                            'tempat_lahir_penanggung_jawab',
                                            ...
                                            <div>
                                                ...
                                                <TextInput
                                                    ...
                                                    type="date"
                                                    value={
                                                        data.tanggal_lahir_penanggung_jawab
                                                    }
                                                    onChange={(e) =>
                                                        setData(
                                                            'tanggal_lahir_penanggung_jawab',
                                            ...
                                            <div>
                                                <Label
                                                    ...
                                                    color={
                                                        errors.telepon_penanggung_jawab
                                                            ? 'failure'
                                                            : 'gray'
                                                    }
                                                >
                                            ...
                                            <div>
                                                ...
                                                <Select
                                                    ...
                                                    className="mt-1"
                                                    value={
                                                        data.jenis_kelamin_penanggung_jawab
                                                    }
                                                    onChange={(e) =>
                                                        setData(
                                                            'jenis_kelamin_penanggung_jawab',
                                            ...
                                            <div className="md:col-span-2">
                                                <Label
                                                    ...
                                                    color={
                                                        errors.alamat_penanggung_jawab
                                                            ? 'failure'
                                                            : 'gray'
                                                    }
                                                >
                                        ...
                                        <div className="flex gap-6">
                                            <div className="flex items-center">
                                                <Checkbox
                                                    ...
                                                    checked={
                                                        data.hasil_dikirim_ke_pasien
                                                    }
                                                    onChange={(e) =>
                                                        setData(
                                                            'hasil_dikirim_ke_pasien',
                                                            e.target.checked,
                                                        )
                                                    }
                                                ...
                                                <Label
                                                    ...
                                                    color={
                                                        errors.hasil_dikirim_ke_pasien
                                                            ? 'failure'
                                                            : 'gray'
                                                    }
                                                    className="ms-2"
                                            ...
                                            <div className="flex items-center">
                                                <Checkbox
                                                    ...
                                                    checked={
                                                        data.hasil_dikirim_ke_dokter
                                                    }
                                                    onChange={(e) =>
                                                        setData(
                                                            'hasil_dikirim_ke_dokter',
                                                            e.target.checked,
                                                        )
                                                    }
                                                    className="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600"
                                                ...
                                                <Label
                                                    ...
                                                    color={
                                                        errors.hasil_dikirim_ke_dokter
                                                            ? 'failure'
                                                            : 'gray'
                                                    }
                                                    className="ms-2"
                                    ...
                                    <div className="grid gap-6 xl:grid-cols-[minmax(0,1.45fr)_minmax(320px,0.75fr)]">
                                        <div className="rounded-lg border border-gray-200 bg-gray-50 p-5 dark:border-gray-700 dark:bg-gray-800/50">
                                            ...
                                            <div className="mt-3 text-xs text-gray-500 dark:text-gray-400">
                                                ...
                                                hasil teratas dari kotak
                                                pencarian. Gunakan panel di
                                                bawah jika ingin menelusuri
                                                berdasarkan paket atau kategori
                                                layanan.
                                            </div>
                                        </div>
                                        ...
                                        <div className="rounded-lg border border-blue-200 bg-blue-50 p-5 dark:border-blue-800 dark:bg-blue-900/20">
                                            ...
                                            {overlapWarnings.length > 0 && (
                                                <div className="mt-4 rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800 dark:border-amber-800 dark:bg-amber-900/20 dark:text-amber-300">
                                                    Layanan satuan ini juga
                                                    sudah tercakup di paket:{' '}
                                                    {Array.from(
                                                        new Set(
                                                            overlapWarnings,
                                                        ),
                                        ...
                                        <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                                            <div>
                                                ...
                                                <p className="text-sm text-gray-500 dark:text-gray-400">
                                                    Qty akan disimpan ke detail
                                                    pemeriksaan dan subtotal
                                                    dihitung otomatis.
                                                </p>
                                            </div>
