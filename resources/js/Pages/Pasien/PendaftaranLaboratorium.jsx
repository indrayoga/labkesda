...
export default function PendaftaranLaboratorium({
    ...
    const { data, setData, post, put, processing, errors } = useForm({
        ...
        items: buildInitialSelectedItems(pemeriksaan, paketLayanan).map(
            (item) => ({
                tipe: item.tipe,
                id: item.id,
                harga: item.harga,
    ...
    const handleLayananToggle = (layanan) => {
        syncSelectedItems((prev) => {
            ...
            if (exists) {
                return prev.filter(
                    (item) =>
                        !(item.tipe === 'layanan' && item.id === layanan.id),
                );
            }
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            {currentStep === 2 && (
                                <div className="space-y-6">
                                    ...
                                    Object.keys(listKategoriLayanans).length >
                                        0 ? (
