...
export default function Index({ kategoriLayanan, jenisLayanan }) {
  ...
  return (
    <LabkesdaLayout>
      ...
      <Modal
        ...
        size="2xl"
      >
        <ModalHeader>Filter Jenis Layanan</ModalHeader>
        <ModalBody className="max-w-2xl">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="col-span-2 md:col-span-1">
              <Label htmlFor="kategori_layanan_id">Kategori</Label>
              <Select
                id="cariKategori"
                value={cariKategori}
                onChange={(e) => {
