...
export default function Beranda({
    ...
    useEffect(() => {
        ...
        const fetchStatistikBulanan = async () => {
            try {
                const response = await axios.get(
                    route('beranda.statistik-bulan-ini'),
                );
                        ...
                        {isLoadingKunjunganMingguan ? (
                            ...
                            <div className="space-y-3">
                                {kunjunganMingguan.map((item, index) => {
                                    const value =
                                        Number(item?.jumlah_kunjungan) || 0;
                                    const percentage =
                                        maxKunjungan > 0
                                            ? (value / maxKunjungan) * 100
                                            : 0;
                                    ...
                                    return (
                                        ...
                                        >
                                            <span className="col-span-3 text-xs text-gray-600 dark:text-gray-400 sm:col-span-2">
                                                {item?.tanggal || '-'}
                                            </span>
                                            ...
                                            <span className="col-span-2 text-right text-xs font-semibold text-gray-900 dark:text-gray-100 sm:col-span-1">
                                                {value}
                                            </span>
                                        </div>
                                    );
