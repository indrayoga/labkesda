                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <TextInput
                                ...
                                onChange={(e) =>
                                    setTanggalSampling(e.target.value)
                                }
                                required
                            />
                        </div>
                        ...
                        <p className="text-xs text-gray-500 dark:text-gray-400">
                            Petugas sampling akan otomatis diisi berdasarkan
                            akun yang sedang login.
                        </p>
                        <div className="flex gap-2">
                            <Button
                                onClick={submitSampling}
                                disabled={prosesSampling}
                            >
