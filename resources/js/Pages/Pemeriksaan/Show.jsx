...
const formatReferenceRanges = (ranges = []) => {
    ...
    return ranges
        .map((range) => {
            const genderLabel = range.jenis_kelamin
                ? `${range.jenis_kelamin}: `
                : '';
                                ...
                                <div className="flex items-center justify-between rounded-xl bg-white px-4 py-2">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <div>
                                            ...
                                            <InputError
                                                message={
                                                    errors.tanggal_sampel_diterima
                                                }
                                                className="mt-2"
                                            />
                                            <InputError
                                                message={
                                                    errors.jam_sampel_diterima
                                                }
                                                className="mt-2"
                                            />
                                        </div>
                                ...
                                <div className="flex items-center justify-between rounded-xl bg-white px-4 py-2">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <div>
                                            ...
                                            <InputError
                                                message={
                                                    errors.tanggal_hasil_selesai
                                                }
                                                className="mt-2"
                                            />
                                            <InputError
                                                message={
                                                    errors.jam_hasil_selesai
                                                }
                                                className="mt-2"
                                            />
                                        </div>
                            ...
                            {data.petugas_validasi.map((petugasId, index) => (
                                ...
                                >
                                    <Select
                                        ...
                                        value={petugasId}
                                        onChange={(e) => {
                                            const newPetugasValidasi = [
                                                ...data.petugas_validasi,
                                            ];
                                            newPetugasValidasi[index] =
                                                e.target.value;
                                            setData(
                                                'petugas_validasi',
                                                newPetugasValidasi,
