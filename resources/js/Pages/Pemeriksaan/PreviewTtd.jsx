...
export default function PreviewTtd({ pemeriksaan }) {
    ...
    const signedPdfFileName = useMemo(() => {
        const registrationNumber = pemeriksaan.no_registrasi
            ? String(pemeriksaan.no_registrasi).replace(
                  /[^A-Za-z0-9._-]+/g,
                  '-',
              )
                    ...
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            ...
                            <p className="mt-1 text-sm text-slate-600">
                                Pilih halaman, aktifkan mode atur, lalu
                                tambahkan beberapa posisi TTE di halaman mana
                                pun.
                            </p>
                        </div>
                ...
                >
                    <div className="mx-auto w-fit">
                        <div
                            ...
                            onMouseMove={
                                isPickMode ? handleStampMouseMove : undefined
                            }
                        ...
                        >
                            ...
                            {qrPositions
                                .filter(
                                    (position) => position.page === currentPage,
                                )
                                .map((position) => (
                                    <img
                                        key={position.id}
                    ...
                    <div className="rounded border border-green-200 bg-green-50 p-3 text-sm text-green-800">
                        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                            <p>
                                ...
                                {savedCredential.placementsCount} posisi dengan
                                NIK {savedCredential.nik}.
                            </p>
            ...
            >
                ...
                <form onSubmit={handleSaveCredential}>
                    ...
                    <ModalFooter>
                        <Button
                            color="gray"
                            onClick={() => setOpenModalCredential(false)}
                        >
                            Batal
                        </Button>
