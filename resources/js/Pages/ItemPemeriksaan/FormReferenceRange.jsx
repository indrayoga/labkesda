    ...
    const { data, setData, post, processing, errors, reset } = useForm({
        ranges: item.reference_ranges.length
            ? item.reference_ranges.map((r) => ({
                  ...
                  min_enabled:
                      r.value_type === 'numeric' && r.min_value !== null
                          ? true
                          : false,
                  max_enabled:
                      r.value_type === 'numeric' && r.max_value !== null
                          ? true
                          : false,
                  min: r.min_value,
                  max: r.max_value,
                            ...
                            <tr key={idx} className="text-sm">
                                <td className="border-b border-slate-200 px-3 py-2">
                                    ...
                                    >
                                        ...
                                        {item.kategori_pemeriksaan_nama ==
                                        'LINGKUNGAN' ? (
                                            <>
                                    ...
                                    <InputError
                                        message={errors[`ranges.${idx}.label`]}
                                    />
                                </td>
                                <td className="border-b border-slate-200 px-3 py-2">
                                    <select
                                    ...
                                    <InputError
                                        message={errors[`ranges.${idx}.gender`]}
                                    />
                                </td>
                                <td className="border-b border-slate-200 px-3 py-2">
                                    <select
