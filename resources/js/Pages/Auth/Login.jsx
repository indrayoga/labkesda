        ...
        <>
            ...
            <section className="relative min-h-screen bg-transparent dark:bg-gray-900">
                <div className="mx-auto flex flex-col items-center justify-center px-6 py-8 md:h-screen lg:py-0">
                    ...
                    <div className="w-full rounded-lg bg-white/95 shadow-2xl backdrop-blur-sm dark:border dark:border-gray-700 dark:bg-gray-800/95 sm:max-w-md md:mt-0 xl:p-0">
