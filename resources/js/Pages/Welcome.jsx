                        ...
                        <div className="col-span-6 text-center sm:mb-6 lg:mb-0 lg:text-left">
                            ...
                            >
                                ...
                                <span className="text-sm font-medium">
                                    Sistem Informasi Lab Kesehatan Daerah
                                    Balikpapan
                                </span>
                                <svg
                            ...
                            <p className="mx-auto mb-6 max-w-xl font-light text-gray-500 dark:text-gray-400 md:text-lg lg:mx-0 xl:mb-8 xl:text-xl">
                                Sistem informasi manajemen pemeriksaan
                                laboratorium yang modern, akurat, dan terpercaya
                    ...
                    <div className="grid gap-8 sm:gap-12 md:grid-cols-3">
                        <div className="flex justify-center">
                            ...
                            <div>
                                ...
                                <p className="font-light text-gray-500 dark:text-gray-400">
                                    ...
                                    meliputi kimia klinik, hematologi,
                        ...
                        <div className="flex justify-center">
                            ...
                            <div>
                                ...
                                <p className="font-light text-gray-500 dark:text-gray-400">
                                    Keamanan data pasien terjamin dengan sistem
                                    enkripsi dan akses terbatas sesuai regulasi
                                    kesehatan.
                                </p>
                            </div>
                        </div>
                        <div className="flex justify-center">
                            ...
                            <div>
                                ...
                                <p className="font-light text-gray-500 dark:text-gray-400">
                                    Pantau status sampel dan hasil pemeriksaan
                                    secara real-time dengan laporan yang
                                    terintegrasi.
                                </p>
                            </div>
                        </div>
