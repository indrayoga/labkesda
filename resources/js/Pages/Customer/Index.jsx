...
export default function Index({ customers, kecamatans, kelurahans }) {
  ...
  return (
    <LabkesdaLayout>
        ...
        <div className="relative overflow-hidden bg-white shadow-md dark:bg-gray-800">
          <div className="flex flex-col space-y-3 px-4 py-3 lg:flex-row lg:items-center lg:justify-between lg:space-x-4 lg:space-y-0">
            <div className="flex flex-1 items-center space-x-4">
              <h2>Daftar Customer ({customers.total} entri)</h2>
            </div>
        ...
        <div className="relative overflow-hidden bg-white shadow-md sm:rounded-b-lg dark:bg-gray-800">
          ...
          <div className="flex items-center justify-between border-t bg-gray-50 px-4 py-3 dark:border-gray-600 dark:bg-gray-700">
            <span className="text-sm text-gray-700 dark:text-gray-400">
              Menampilkan{' '}
              <span className="font-semibold">{customers.from}</span> sampai{' '}
              <span className="font-semibold">{customers.to}</span> dari total{' '}
              <span className="font-semibold">{customers.total}</span> entri
            </span>
      ...
      <Modal
        ...
        size="2xl"
      >
        <ModalHeader>Filter Customer</ModalHeader>
        ...
        <ModalBody>
          <div className="max-w-md text-center">
            ...
            <div className="flex justify-center gap-4">
              <Button onClick={() => hapusCustomer(selectedCustomer)}>
                Ya, Saya yakin
              </Button>
              <Button
                color="alternative"
