...
class PemeriksaanRegistrasiService
{
    public function validateRegistrationRequest(Request $request): array
    {
        ...
        $validated = Validator::make($payload, [
            ...
            'tempat_lahir_penanggung_jawab' => 'nullable|string|max:255',
            'tanggal_lahir_penanggung_jawab' => 'nullable|date',
            'alamat_penanggung_jawab' => 'nullable|string',
            'telepon_penanggung_jawab' => 'nullable|string|max:255',
            'hubungan_penanggung_jawab' => 'nullable|in:suami,istri,ayah,ibu,anak,keluarga',
            'jenis_kelamin_penanggung_jawab' => 'nullable|in:Laki-laki,Perempuan',
